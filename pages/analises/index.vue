...
import Bar from '@/components/analises/Bar.vue';
import Area from '@/components/analises/Area.vue';
import Polar from '@/components/analises/Polar.vue';
      ...
      <div class="px-8 py-8 py-lg-0">
        <div class="d-flex justify-space-between">
          <div class="d-flex py-0 align-center">
            <div>
              <h3 class="text-h3 mb-2">Análises</h3>
              <ul
              ...
              >
                ...
                <li
                  ...
                  text="Usinas"
                >
                  <h6 class="text-medium-emphasis text-subtitle-1">Análises</h6>
                </li>
                <!----><!---->
              </ul>
            </div>
          ...
          <div class="d-none py-0 d-lg-block overflow-hidden">
            <div class="mb-n16 mt-3">
              <img src="https://i.imgur.com/ekzXevw.png" height="200" alt="breadcrumbw" />
            </div>
          </div>
        </div>
      </div>
  ...
  <v-row>
    <v-col cols="12" md="6">
        <div class="elevation-3">
          <UiParentCard title="Quantidade utilizada Carregadores"> 
            <Bar />
            </UiParentCard>  
        </div>
    </v-col>
    ...
    <v-col cols="12" md="6">
        <div class="elevation-3">
            <UiParentCard title="Regiões menos utilizadas"> 
            <Polar/>
            </UiParentCard>  
        </div>
    </v-col>
